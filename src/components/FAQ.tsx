...
const faqs = [
    {
        question: '리뷰닥터와 세일즈랩은 다른 서비스인가요?',
        answer: (
            <>
                아뇨, 같은 서비스입니다! 기존 리뷰닥터의 AI 리뷰 관리 기능은 <span className="font-bold bg-blue-50 text-blue-700 px-1 py-0.5 rounded">그대로 유지</span>하면서, 매출 현황 및 분석 등 사장님들께 필요한 기능을 대폭 추가하며 <span className="font-bold text-blue-600">'세일즈랩'</span>이라는 새로운 이름으로 업그레이드 되었습니다. <br /><br />
                기존 계정과 연동 데이터는 모두 그대로 유지되니 안심하고 사용하셔도 됩니다.
            </>
        ),
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                ...
                <p>
                    <span className="font-bold bg-blue-50 text-blue-700 px-1 py-0.5 rounded">프로 상품</span>은 연동된 가게의 리뷰를 설정하신 기준에 따라 세일즈랩이 대신하여 자동으로 관리합니다. 대시보드에서 가게 노출 랭킹까지 확인이 가능하며, 부정리뷰 알림톡이 실시간으로 발송됩니다.<br />
    ...
    },
    {
        ...
        answer: '아뇨. 리뷰 개수는 무제한입니다. 세일즈랩은 가게 연동 개수로 구독료를 과금하고 있습니다.',
    },
    {
    ...
    },
    {
        ...
        answer: (
            <>
                ...
                <br /><br />
                추가로 <span className="font-bold bg-emerald-50 text-emerald-700 px-1 py-0.5 rounded">OKPOS, UNION POS, Easy POS 3종의 POS와도 매출 연동</span>이 가능하고, 여신금융협회 연동으로 카드 입금 내역까지 확인할 수 있어 오프라인 매출까지 한 번에 관리할 수 있습니다.
                <br /><br />
    ...
    {
        question: 'POS·여신금융협회 연동도 가게 수에 포함되나요? 추가 비용이 있나요?',
        answer: (
            <>
                아니요. <span className="font-bold bg-emerald-50 text-emerald-700 px-1 py-0.5 rounded">홀 매출·정산 연동은 가게 수에 포함되지 않으며, 무료로 추가</span>하실 수 있습니다.
                <br /><br />
                현재 <span className="font-bold">OKPOS, UNION POS, Easy POS</span> 3종의 POS를 지원하며, 배달 매출과 POS 매출을 함께 통합해 진짜 가게 매출을 한눈에 확인하실 수 있습니다.
                <br /><br />
                추가로 <span className="font-bold bg-emerald-50 text-emerald-700 px-1 py-0.5 rounded">여신금융협회 연동</span>으로 카드 입금 내역까지 확인하실 수 있어, 매출부터 실제 정산까지 한 번에 관리하실 수 있습니다.
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                없습니다. 세일즈랩은 월 구독 형태로 운영되며, 마음에 들지 않을 시 언제든지 유료 구독을 취소하실 수 있습니다.
                <br /><br />
